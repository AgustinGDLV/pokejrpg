...
#define ACTIONS_CONFIRMED_COUNT 8 // 0 - 7 are used to store battler actions during selection
#define MULTISTRING_CHOOSER     9
#define MISS_TYPE               10
#define MSG_DISPLAY             11
#define BATTLE_COMMUNICATION_ENTRIES_COUNT  12
