...
#define MAX_BATTLERS_COUNT      8
#define MAX_PLAYER_BATTLERS     3
#define MAX_OPPONENT_BATTLERS   5

#define B_POSITION_PLAYER_LEFT        0
#define B_POSITION_PLAYER_MIDDLE      1
#define B_POSITION_PLAYER_RIGHT       2
#define B_POSITION_OPPONENT_LEFT      3
#define B_POSITION_OPPONENT_RIGHT     4
#define B_POSITION_OPPONENT_3         5
#define B_POSITION_OPPONENT_4         6
#define B_POSITION_OPPONENT_5         7

// These macros can be used with either battler ID or positions to get the partner or the opposite mon
#define BATTLE_OPPOSITE(id) ((id) ^ BIT_SIDE)
#define BATTLE_PARTNER(id) (((id) + 1) % MAX_PLAYER_BATTLERS) // *TODO -- rework
...
#define HITMARKER_IGNORE_BIDE           (1 << 4)
#define HITMARKER_DESTINYBOND           (1 << 5)
#define HITMARKER_IGNORE_SUBSTITUTE     (1 << 6)
#define HITMARKER_NO_ATTACKSTRING       (1 << 7)
#define HITMARKER_ATTACKSTRING_PRINTED  (1 << 8)
#define HITMARKER_NO_PPDEDUCT           (1 << 9)
#define HITMARKER_SWAP_ATTACKER_TARGET  (1 << 10)
#define HITMARKER_STATUS_ABILITY_EFFECT (1 << 11)
#define HITMARKER_SYNCHRONISE_EFFECT    (1 << 12)
#define HITMARKER_RUN                   (1 << 13)
#define HITMARKER_IGNORE_DISGUISE       (1 << 14)
#define HITMARKER_DISABLE_ANIMATION     (1 << 15)   // disable animations during battle scripts, e.g. for Bug Bite
// 3 free spots because of change in handling of UNDERGROUND/UNDERWATER/ON AIR
#define HITMARKER_UNABLE_TO_USE_MOVE    (1 << 16)
#define HITMARKER_PASSIVE_DAMAGE        (1 << 17)
#define HITMARKER_DISOBEDIENT_MOVE      (1 << 18)
...
#define HITMARKER_CHARGING              (1 << 23)
#define HITMARKER_FAINTED(battler)      (1u << (battler + 24))
#define HITMARKER_FAINTED2(battler)     HITMARKER_FAINTED(battler)
#define HITMARKER_STRING_PRINTED        (1 << 25)
