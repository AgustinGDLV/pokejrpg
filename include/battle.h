...
struct BattleStruct
{
    ...
    bool8 selectedForSwitch[PARTY_SIZE];
    u8 stringMoveType;
...
// *TODO -- fix assert
STATIC_ASSERT(sizeof(((struct BattleStruct *)0)->palaceFlags) * 8 >= 4 + MAX_MON_MOVES, PalaceFlagsTooSmall)
...
{
    if (GetBattlerPosition(battler) < MAX_PLAYER_BATTLERS)
