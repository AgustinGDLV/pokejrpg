...
const u32 gHealthboxGfx[] = INCBIN_U32("graphics/battle_interface_custom/healthbox.4bpp.lz");
const u16 gHealthboxPal[] = INCBIN_U16("graphics/battle_interface_custom/healthbox.gbapal");
