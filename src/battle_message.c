...
static const u8 sText_WildPkmnAppeared[] = _("Wild POKéMON appeared!\p");
...
const u8 gText_BattleMenu[] = _("{CLEAR_TO 10}FIGHT{CLEAR_TO 98}BAG\n{CLEAR_TO 10}POKéMON{CLEAR_TO 98}RUN");
